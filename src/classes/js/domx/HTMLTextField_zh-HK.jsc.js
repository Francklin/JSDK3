...
_$class._localeResource={
	...
	"canotLessItems": "您選擇的\"{0}\"的條目數不能少於{1}條!",
	"canotGreaterItems": "您選擇的\"{0}\"的條目數不能超過{1}條!",
	"canotLessWords": "您輸入的\"{0}\"的字数不能少於{1}字!",
	"canotGreaterWords": "您輸入的\"{0}\"的字數不能超過{1}字!",
	"itemsLimit": "元素個數限制: {0} - {1}",
	"wordsLimit": "長度限制: {0} - {1}",
	"atLeastItems": "至少{0}个!",
	"atMostItems": "最多{0}个!",
	"atLeastWords": "至少{0}字!",

...
_$class._localeResource={
	"dateFormat": "日期格式為: YYYY-MM-DD \n 例如: 2012-05-30",
	"timeFormat": "時間格式為: HH:MM:SS \n 例如: 23:59:59",
	"datetimeFormat": "日期格式為: YYYY-MM-DD HH:MM:SS \n例如: 2012-05-30 23:59:59",
	"pleaseInput": "請選擇或輸入\"{0}\"!",
	"isnotDate": "您輸入的\"{0}\"不是日期！請注意格式：\n\n{1}",
	"mustLess": "您輸入的\"{0}\"必須小於(等於)\"{1}\"!",
	"mustGreater": "您輸入的\"{0}\"必須大於(等於)\"{1}\"!"
}
